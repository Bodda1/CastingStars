...
namespace CastingStars.Helpers
{
    public static class CultureHelper
    {
        ...
        private static readonly List<string> _cultures = new List<string> { "en", "ar" };
        ...
        public static string GetCurrentURLWithoutCulture(string url)
        {
            var vars = url.Split(new char[] { '/' });
